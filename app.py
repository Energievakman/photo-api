...
def process_zip_bytes(zip_bytes, output_zip, used_names, written_paths, max_width=1600, quality=75):
    ...
    Dit voorkomt dat Render vastloopt door te veel geheugenverbruik.
    """
    try:
        with ZipFile(zip_bytes, "r") as input_zip:
            ...
            def flush_image_batch():
                ...
                with ThreadPoolExecutor(max_workers=active_workers) as executor:
                    ...
                    # ZIP schrijven blijft sequentieel; ZipFile schrijven is niet thread-safe.
                    for result in results:
            ...
            for info in input_zip.infolist():
                ...
                if is_image(original_path):
                    ...
                    # Belangrijk: kleine batches, anders krijg je memory spikes en 502 op Render.
