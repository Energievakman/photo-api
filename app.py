...
<head>
  ...
  <style>
    ...
    .dropzone span { color: #666; font-size: 14px; }
    input[type="file"] { display: none; }
    .file-name { margin-top: 10px; color: #333; font-weight: 600; }
    .dropzone {
      border: 2px dashed #b8b8b8;
      border-radius: 10px;
      padding: 26px;
...
<body>
  ...
  <form action="/process-photos" method="post" enctype="multipart/form-data">
    <label class="dropzone" id="dropzone">
      <strong>Sleep je ZIP-bestand hierheen</strong>
      <span>of klik om een ZIP/foto's te kiezen</span>
